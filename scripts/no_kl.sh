...
#SBATCH --job-name=no_KL# create a short name for your job
#SBATCH --output=/lustre/scratch/client/movian/research/users/quanpn2/public/HiOT/sbatch_results/no_KL.out # create a output file
#SBATCH --error=/lustre/scratch/client/movian/research/users/quanpn2/public/HiOT/sbatch_results/no_KL.err # create a error file
...
torchrun --nproc_per_node=2 --master_port=23000 deit/main_suppix_hier.py \
  --model cast_small \
  --batch-size 256 \
  --epochs 100 \
