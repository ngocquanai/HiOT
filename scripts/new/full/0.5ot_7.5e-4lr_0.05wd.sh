...
#SBATCH --job-name=6e-4# create a short name for your job
#SBATCH --output=/lustre/scratch/client/movian/research/users/quanpn2/public/HiOT/results_new/full/0.5ot_7.5e-4lr_0.05wd.out # create a output file
#SBATCH --error=/lustre/scratch/client/movian/research/users/quanpn2/public/HiOT/results_new/full/0.5ot_7.5e-4lr_0.05wd.err # create a error file
...
torchrun --nproc_per_node=2  --master_port=$MASTER_PORT deit/main_suppix_hier.py \
  --weight-decay 0.05 \
  --lr 7.5e-4 \
  --model cast_small \
  --batch-size 256 \
  ...
  --data-path ../dataset/ \
  --output_dir ./output/new_baseline/full/0.5ot_7.5e-4lr_0.05wd  \
