...
#SBATCH --output=/lustre/scratch/client/movian/research/users/quanpn2/public/HiOT/results_new/full/1ot.out # create a output file
#SBATCH --error=/lustre/scratch/client/movian/research/users/quanpn2/public/HiOT/results_new/full/1ot.err # create a error file
...
CUDA_VISIBLE_DEVICES='0,1' torchrun --nproc_per_node=2  --master_port=$MASTER_PORT deit/main_suppix_hier.py \
  ...
  --data-path ../dataset/ \
  --output_dir ./output/new/full/1ot  \
  --base_weight 1 \
  --ot_loss --ot_weight 1 \
