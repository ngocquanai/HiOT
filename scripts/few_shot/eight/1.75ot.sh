...
#SBATCH --output=/lustre/scratch/client/movian/research/users/quanpn2/public/HiOT/results_new/few_shot/eight/1.75ot.out # create a output file
#SBATCH --error=/lustre/scratch/client/movian/research/users/quanpn2/public/HiOT/results_new/few_shot/eight/1.75ot.err # create a error file
...
torchrun --nproc_per_node=1  --master_port=$MASTER_PORT deit/main_suppix_hier.py \
  ...
  --data-path ../dataset/ \
  --output_dir ./output/few_shot/eight/1.75ot \
  --ot_loss --ot_weight 1.75 \
