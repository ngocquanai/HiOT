...
#SBATCH --output=/lustre/scratch/client/movian/research/users/quanpn2/public/HiOT/results_new/few_shot/four/10ot.out # create a output file
#SBATCH --error=/lustre/scratch/client/movian/research/users/quanpn2/public/HiOT/results_new/few_shot/four/10ot.err # create a error file
...
torchrun --nproc_per_node=1  --master_port=25325 deit/main_suppix_hier.py \
  ...
  --data-path ../dataset/ \
  --output_dir ./output/few_shot/four/10ot \
