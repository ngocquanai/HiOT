...
#SBATCH --job-name=0.5base0.5ot# create a short name for your job
#SBATCH --output=/lustre/scratch/client/movian/research/users/quanpn2/public/HiOT/results/learnable/0.5base0.5ot.out # create a output file
#SBATCH --error=/lustre/scratch/client/movian/research/users/quanpn2/public/HiOT/results/learnable/0.5base0.5ot.err # create a error file
...
torchrun --nproc_per_node=2  --master_port=23865 deit/main_suppix_hier.py \
  --model cast_small \
  --batch-size 256 \
  --epochs 100 \
  ...
  --data-path ../dataset/ \
  --output_dir ./output/learnable/0.5base0.5ot/ \
