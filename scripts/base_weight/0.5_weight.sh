...
#SBATCH --output=/lustre/scratch/client/movian/research/users/quanpn2/public/HiOT/results/base_weight/0.5weight.out # create a output file
#SBATCH --error=/lustre/scratch/client/movian/research/users/quanpn2/public/HiOT/results/base_weight/0.5weight.err # create a error file
...
torchrun --nproc_per_node=4  --master_port=23865 deit/main_suppix_hier.py \
  ...
  --data-path ../dataset/ \
  --output_dir ./output/base_weight/0.5weight/ \
