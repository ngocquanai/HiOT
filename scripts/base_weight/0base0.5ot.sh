...
#SBATCH --job-name=0b0.5ot# create a short name for your job
#SBATCH --output=/lustre/scratch/client/movian/research/users/quanpn2/public/HiOT/results/base_weight/0base_0.5ot.out # create a output file
#SBATCH --error=/lustre/scratch/client/movian/research/users/quanpn2/public/HiOT/results/base_weight/0base_0.5ot.err # create a error file
...
torchrun --nproc_per_node=4  --master_port=23865 deit/main_suppix_hier.py \
  ...
  --data-path ../dataset/ \
  --output_dir ./output/base_weight/0base0.5ot/ \
