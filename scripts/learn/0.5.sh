...
#SBATCH --output=/lustre/scratch/client/movian/research/users/quanpn2/public/HiOT/results/learnable/hiot05.out # create a output file
#SBATCH --error=/lustre/scratch/client/movian/research/users/quanpn2/public/HiOT/results/learnable/hiot05.err # create a error file
...
torchrun --nproc_per_node=2  --master_port=23517 deit/main_suppix_hier.py \
  --model cast_small \
  --batch-size 256 \
  --epochs 100 \
  ...
  --ot_loss --learnable_ot --ot_weight 0.5 \
  --finetune best_checkpoint.pth \
  --tree_path ./data/inat21_3tree.json --distributed

chmod 777 -R /lustre/scratch/client/movian/research/users/quanpn2/public/HiOT/results/learnable