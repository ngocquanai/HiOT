...
def get_args_parser():
    ...
    parser.add_argument('--num-superpixels', type=int, default=196, help='number of superpixels')
...
def main(args):
    ...
    if args.finetune:
        ...
        for k in ['head.weight', 'head.bias', 'head_dist.weight', 'head_dist.bias', 'cls_token']:
