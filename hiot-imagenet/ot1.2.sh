...
#SBATCH --output=/lustre/scratch/client/movian/research/users/quanpn2/public/HiOT/hiot-imagenet/sbatch/ot1.2.out # create a output file
#SBATCH --error=/lustre/scratch/client/movian/research/users/quanpn2/public/HiOT/hiot-imagenet/sbatch/ot1.2.err # create a error file
...
OUTPUT_PATH="./local/ot1.2"


## OT LOSS uniform weight
CUDA_VISIBLE_DEVICES='0,1' python -m torch.distributed.launch --master_port 29505 --nproc_per_node=2 --use_env main.py \
--model deit_tiny_patch16_224 --batch-size 1024 --data-path $DATA_PATH --output_dir $OUTPUT_PATH \
--ot-loss --tree_folder_path ./tree --base-weight 1 --ot-weight 1.2
