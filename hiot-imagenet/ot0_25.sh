...
#SBATCH --output=/lustre/scratch/client/movian/research/users/quanpn2/public/HiOT/hiot-imagenet/sbatch/ot0_25.out # create a output file
#SBATCH --error=/lustre/scratch/client/movian/research/users/quanpn2/public/HiOT/hiot-imagenet/sbatch/ot0_25.err # create a error file
...
--ot-loss --tree_folder_path ./tree --base-weight 1 --ot-weight 0 --data_fraction 0.25
