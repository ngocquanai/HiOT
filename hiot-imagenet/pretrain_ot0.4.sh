...
#SBATCH --output=/lustre/scratch/client/movian/research/users/quanpn2/public/HiOT/hiot-imagenet/sbatch/pretrained_ot0.4.out # create a output file
#SBATCH --error=/lustre/scratch/client/movian/research/users/quanpn2/public/HiOT/hiot-imagenet/sbatch/pretrained_ot0.4.err # create a error file
...
OUTPUT_PATH="./local/pretrain_ot0.4"


## OT LOSS uniform weight
CUDA_VISIBLE_DEVICES='0,1' python -m torch.distributed.launch --master_port 17505 --nproc_per_node=2 --use_env main.py \
--model deit_tiny_patch16_224 --batch-size 1024 --lr 3e-5 --data-path $DATA_PATH --output_dir $OUTPUT_PATH \
--ot-loss --tree_folder_path ./tree --base-weight 1 --ot-weight 0.4 --finetune ./local/base_runtime/18_01_2026_01:41:35_deit_tiny_patch16_224_checkpoint.pth
