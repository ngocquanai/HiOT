...
PATH_TO_IMAGENET_VAL = '/mnt/data/khoinnm/imagenet/val'
...
def build_dataset(is_train, args):
    ...
    if args.data_set == 'CIFAR':
        ...
        if is_train and hasattr(args, 'data_fraction') and args.data_fraction < 1.0:
            ...
            print(f"--- Training on {args.data_fraction*100}% of ImageNet: {len(dataset)} samples ---")
        else :
            print("Full of ImageNet")
